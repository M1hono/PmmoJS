...
public class EntityNBTBuilder {
    ...
    private final EntitySettingsBuilder parent;
    ...
    public EntityNBTBuilder(EntitySettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, ReqType reqType, boolean isOverride) {
        this.parent = parent;
    ...
    public EntityNBTBuilder(EntitySettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, EventType eventType, boolean isOverride) {
        this.parent = parent;
        this.objectType = objectType;
        this.objectId = objectId;
        this.reqType = null;
    ...
    public EntityNBTBuilder(EntitySettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, ModifierDataType modifierType, boolean isOverride) {
        this.parent = parent;
        this.objectType = objectType;
        this.objectId = objectId;
        this.reqType = null;
    ...
    public EntityNBTBuilder behavior(BehaviorToPrevious behavior) {
        this.behavior = behavior;
        return this;
    }

    @Info("Sets whether requirements should be added or replace existing ones (should_cases_add field)")
    public EntityNBTBuilder additive(boolean additive) {
        this.additive = additive;
        return this;
    }

    @Info("Creates a new case with the specified NBT path")
    public EntityNBTBuilder newCase(String nbtPath) {
    ...
    public EntityNBTBuilder path(String nbtPath) {
    ...
    public EntityNBTBuilder paths(List<String> nbtPaths) {
        if (currentPaths.isEmpty() && !cases.isEmpty()) {
            // Starting a new case
            currentPaths = new ArrayList<>();
            currentCriteria = new ArrayList<>();
    ...
    public EntityNBTBuilder criteria(Operator operator, List<String> comparators, Map<String, ? extends Number> skillValues) {
    ...
    public EntityNBTBuilder addCriteria(Operator operator, List<String> comparators, String skill, Number value) {
    ...
    public EntityNBTBuilder equals(String[] comparators, String skill, Number value) {
    ...
    public EntityNBTBuilder equals(String comparator, String skill, Number value) {
        return addCriteria(Operator.EQUALS, List.of(comparator), skill, value);
    }

    @Info("Adds a GREATER_THAN criteria for a numeric value")
    public EntityNBTBuilder greaterThan(Number comparator, String skill, Number value) {
    ...
    public EntityNBTBuilder lessThan(Number comparator, String skill, Number value) {
    ...
    public EntityNBTBuilder greaterThanOrEqual(Number comparator, String skill, Number value) {
    ...
    public EntityNBTBuilder lessThanOrEqual(Number comparator, String skill, Number value) {
    ...
    public EntityNBTBuilder exists(String skill, Number value) {
        Map<String, Double> values = new HashMap<>();
        values.put(skill, value.doubleValue());
    ...
    public EntityNBTBuilder enchantmentRequirement(String enchantmentId, String skill, Number requiredLevel) {
    ...
    public EntitySettingsBuilder done() {
        if (!currentPaths.isEmpty() && !currentCriteria.isEmpty()) {
            saveCurrentCase();
        }
