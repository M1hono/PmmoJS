...
public class BlockNBTBuilder {

    private final BlockSettingsBuilder parent;
    ...
    public BlockNBTBuilder(BlockSettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, ReqType reqType, boolean isOverride) {
        this.parent = parent;
    ...
    public BlockNBTBuilder(BlockSettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, EventType eventType, boolean isOverride) {
        this.parent = parent;
        this.objectType = objectType;
        this.objectId = objectId;
        this.reqType = null;
    ...
    public BlockNBTBuilder(BlockSettingsBuilder parent, ObjectType objectType, ResourceLocation objectId, ModifierDataType modifierType, boolean isOverride) {
        this.parent = parent;
        this.objectType = objectType;
        this.objectId = objectId;
        this.reqType = null;
    ...
    public BlockNBTBuilder path(String nbtPath) {
    ...
    public BlockNBTBuilder paths(List<String> nbtPaths) {
        if (currentPaths.isEmpty() && !cases.isEmpty()) {
            currentPaths = new ArrayList<>();
            currentCriteria = new ArrayList<>();
        }
    ...
    public BlockNBTBuilder criteria(Operator operator, List<String> comparators, Map<String, ? extends Number> skillValues) {
    ...
    public BlockNBTBuilder addCriteria(Operator operator, List<String> comparators, String skill, Number value) {
    ...
    public BlockNBTBuilder equals(String[] comparators, String skill, Number value) {
    ...
    public BlockNBTBuilder equals(String comparator, String skill, Number value) {
        return addCriteria(Operator.EQUALS, List.of(comparator), skill, value);
    }

    @Info("Adds a GREATER_THAN criteria for a numeric value")
    public BlockNBTBuilder greaterThan(Number comparator, String skill, Number value) {
    ...
    public BlockNBTBuilder lessThan(Number comparator, String skill, Number value) {
    ...
    public BlockNBTBuilder greaterThanOrEqual(Number comparator, String skill, Number value) {
    ...
    public BlockNBTBuilder lessThanOrEqual(Number comparator, String skill, Number value) {
    ...
    public BlockNBTBuilder exists(String skill, Number value) {
        Map<String, Double> values = new HashMap<>();
        values.put(skill, value.doubleValue());
    ...
    public BlockNBTBuilder enchantmentRequirement(String enchantmentId, String skill, Number requiredLevel) {
    ...
    public BlockSettingsBuilder done() {
        if (!currentPaths.isEmpty() && !currentCriteria.isEmpty()) {
            saveCurrentCase();
        }
