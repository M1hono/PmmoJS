...
PmmoJS ships with ProbeJS support for both ProbeJS and ProbeJS Legacy. Type completions for enum values, event objects, and utility classes are provided automatically when ProbeJS generates its type definitions.
